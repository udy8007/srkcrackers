...
export const CHAT_REPLIES: ChatReply[] = [
  ...
  { keys: ["address", "location", "map", "where", "place"], reply: "📍 <b>SRK CRACKERS</b><br>Avadi, Tiruvallur District, TN<br>Survey No 280/79, Door No 45<br>Mogai Village, Avadi Taluk<br><a href='#map'>View on Map →</a>" },
  ...
  { keys: ["license", "licence", "legal", "govt"], reply: "🏛️ <b>Licensed Dealer</b> — SRK CRACKERS<br>Capacity: 100 KGS Fireworks<br>Mogai, Avadi, Tiruvallur<br><a href='#about'>View licence info →</a>" },
