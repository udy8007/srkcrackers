...
export const CHAT_REPLIES: ChatReply[] = [
  ...
  { keys: ["min", "minimum", "order amount"], reply: "💰 <b>Minimum Order:</b><br>• Tamil Nadu &amp; PY: <b>₹3000</b><br>• Other States: <b>₹5000</b><br>🎁 <b>Free postal charge</b> on orders above ₹1000!" },
  { keys: ["delivery", "ship", "transport", "courier", "postal", "postage", "free delivery"], reply: "🚚 We deliver across Tamil Nadu &amp; India via registered transport. 🎁 <b>FREE postal charge on orders above ₹1000!</b> Call <b>98419 16899</b> for delivery details." },
  { keys: ["license", "licence", "legal", "govt", "gst", "gstin"], reply: "🏛️ <b>Licensed Dealer</b> — SRK CRACKERS SHOP<br>Licence No 10439/FL/NMSB/2026<br>GST No 33BJBPR5461B2ZI<br>Morai, Avadi, Chennai<br><a href='#about'>View licence info →</a>" },
