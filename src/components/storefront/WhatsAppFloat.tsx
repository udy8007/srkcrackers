...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="pulse-whatsapp fixed bottom-20 left-4 z-[55] flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg transition hover:scale-105 sm:bottom-24"
    >
